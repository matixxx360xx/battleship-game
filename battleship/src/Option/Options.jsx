...
export default function Options({ setLoopMusic, setMusicVolume, loopMusic, musicVolume }) {
                ...
                <div className="parchment">
                    ...
                    <nav>
                        <button className="item" onClick={() => { setLoopMusic(prev => !prev) }}>
                            ...
                            <span className="label">Muzyka w tle: {loopMusic ? "Włączona" : "Wyłączona"}</span>
                        </button>
                        <div className="item">
                            <span className="badge">
                                <svg viewBox="0 0 24 24"><path d="M12 3 L12 21 M3 6 L21 6 M3 12 L21 12 M3 18 L21 18" /></svg>
                            </span>
                            <span className="label">Głośność muzyki:</span>
                        ...
                        <button className="item">
                            ...
                            <span className="label" onClick={() => navigate("/")}>
                                Wyjdź
                            </span>
                        </button>
                    </nav>
